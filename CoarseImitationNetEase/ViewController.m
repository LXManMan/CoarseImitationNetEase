...
@interface ViewController ()<UIScrollViewDelegate,LXSegmentControlDelegate>
...
- (void)setupSegmentedControl {
    ...
    _mainScrollView.frame = CGRectMake(0, 64+44, self.view.frame.size.width, self.view.frame.size.height);
